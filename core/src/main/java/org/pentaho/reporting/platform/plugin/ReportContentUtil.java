...
public class ReportContentUtil {
  ...
  public static final String USE_SPECIFIC_DATE = "Use Specific Date";
  public static final String DAYS = "Days";
  public static final String WEEKS = "Weeks";
  public static final String MONTHS = "Months";
  public static final String MONTHS_CALENDAR = "Months (Calendar)";
  public static final String QUARTER_CALENDAR = "Quarter (Calendar)";
  public static final String QUARTER_FISCAL = "Quarter (Fiscal)";
  public static final String YEARS = "Years";
  public static final String YEARS_CALENDAR = "Years (Calendar)";
  public static final String YEARS_FISCAL = "Years (Fiscal)";
  ...
  protected static ParameterDefinitionEntry[] addRelativeDateFields( ParameterDefinitionEntry[] inputParams, String startDateParamName, String endDateParamName ) {
    ...
    checkboxParam.setParameterAttribute( ParameterAttributeNames.Core.NAMESPACE, ParameterAttributeNames.Core.TYPE, ParameterAttributeNames.Core.TYPE_RADIO );
    checkboxParam.setParameterAttribute( ParameterAttributeNames.Core.NAMESPACE, ParameterAttributeNames.Core.LABEL, "Date Range" );
    checkboxParam.setParameterAttribute( ParameterAttributeNames.Core.NAMESPACE, ParameterAttributeNames.Core.LAYOUT, ParameterAttributeNames.Core.LAYOUT_HORIZONTAL );
    checkboxParam.setParameterAttribute( ParameterAttributeNames.Core.NAMESPACE, ParameterAttributeNames.Core.PARAMETER_GROUP, "Date Param Toggle" );
    checkboxParam.addValues( USE_SPECIFIC_DATE, USE_SPECIFIC_DATE );
    ...
    unitParam.addValues( MONTHS_CALENDAR, MONTHS_CALENDAR );
    unitParam.addValues( QUARTER_CALENDAR, QUARTER_CALENDAR );
    unitParam.addValues( QUARTER_FISCAL, QUARTER_FISCAL );
    unitParam.addValues( MONTHS, MONTHS );
    unitParam.addValues( YEARS, YEARS );
    unitParam.addValues( YEARS_CALENDAR, YEARS_CALENDAR );
    unitParam.addValues( YEARS_FISCAL, YEARS_FISCAL );
