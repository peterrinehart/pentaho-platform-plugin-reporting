...
public class ReportContentUtil {
  ...
  private static final String startDateParamName = ClassicEngineBoot.getInstance().getGlobalConfig().getConfigProperty( CONFIG_START_DATE_RANGE_PARAM_NAME, "" );
  private static final String endDateParamName = ClassicEngineBoot.getInstance().getGlobalConfig().getConfigProperty( CONFIG_END_DATE_RANGE_PARAM_NAME, "" );
  ...
  public static ValidationResult applyInputsToReportParameters( final MasterReport report,
    ...
    if ( inputs != null ) {
      ...
      if ( injectRelativeDateParams( params ) ) {
  ...
  private static boolean injectRelativeDateParams( ParameterDefinitionEntry[] inputParams ) {
